...
#define ADC_VREF 3.42            // ADC referans voltajı (V) -0.10v **************************
#define ADC_MAX_VALUE 4095.0      // ADC Maksimum Değeri (12-bit için 4095)  

// Cihaz ID'si 
#define DEVICE_ID "002" // Cihaz ID'si (örneğin, "001", "002", ...)*********************

#define uykusuresi (30 * 1000000)  // 30 saniye**********************
...
#define CommStack_ConnGPS_MaxRetry   5    // Maksimum GPS bağlantı deneme sayısı - Varsayılan 5
...
#define PWR_sim808 5  // BME280 sensörünü açma/kapama pini
